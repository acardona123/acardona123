<h1 align="center">Alex Cardona</h1>
...
<p align="center">
  <a href="https://www.linkedin.com/in/cardona-alex">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
  </a>
  <a href="mailto:alex.cardona@free.fr">
...
<p>
  ...
  <img src="https://img.shields.io/badge/Assembly-525252?style=for-the-badge&logo=gnubash&logoColor=white" alt="Assembly x86-64"/>
...
<p>
  ...
  <img src="https://img.shields.io/badge/GDB-4B275F?style=for-the-badge&logo=gnu&logoColor=white" alt="GDB"/>
...
<p>
  <img src="https://img.shields.io/badge/Bare%20Metal-1C1C1C?style=for-the-badge&logo=arduino&logoColor=white" alt="Bare metal"/>
  <img src="https://img.shields.io/badge/ATmega328p-00979D?style=for-the-badge&logo=arduino&logoColor=white" alt="ATmega328p"/>
  <img src="https://img.shields.io/badge/UART%20·%20I²C%20·%20SPI-005571?style=for-the-badge" alt="UART I2C SPI"/>
</p>
...
| **[Webserv](https://github.com/acardona123/42_webserv)**                   | An HTTP server written in C++ from the RFC up: raw sockets, a non-blocking `select` loop, request parsing and CGI.                                                                                                           | C++ · Sockets · select                    |
...
| Project                                                                | Language    | What it taught me                                                 |
| ---------------------------------------------------------------------- | ----------- | ----------------------------------------------------------------- |
...
| [get_next_line](https://github.com/acardona123/42_get_next_line)       | C           | Buffered reading and static state across calls                    |
| [Push_swap](https://github.com/acardona123/42_Push_swap)               | C           | Sorting under a constrained instruction set, algorithmic cost     |
| [Minitalk](https://github.com/acardona123/42_minitalk)                 | C           | Inter-process communication with UNIX signals                     |
| [so_long](https://github.com/acardona123/42_so_long)                   | C           | 2D rendering with MiniLibX, map validation, my own allocator      |
| [Cub3D](https://github.com/acardona123/42_Cub3D)                       | C           | 3D ray casting, engine architecture, configurable at compile time |
| [Philosophers](https://github.com/acardona123/42_Philosophers)         | C           | Threads, mutexes, and the dining philosophers deadlock            |
...
<p align="center">
  <a href="https://www.linkedin.com/in/cardona-alex">LinkedIn</a> ·
  <a href="mailto:alex.cardona@free.fr">alex.cardona@free.fr</a>
</p>
